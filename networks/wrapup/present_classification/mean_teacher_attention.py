...
from networks.wrapup.present_classification.dataset import Mean_Teacher_dataset
...
model = Mean_Teacher_model_1d(ckpt_path='models/', tsboard_path='log/', network=resnet_1d,input_shape=[45, 1],
                   num_classes=12, feature_num=45, dev_num=11, lr=0.0001, batch_size=1000, max_step = 50000)
#
